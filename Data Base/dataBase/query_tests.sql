...
select inv_name
from Inventory b, Packages c
where b.inv_id = c.inv_id and pack_name = 'Surf';

prompt *********************************************************
prompt
prompt Pulling all surfboards available that are in the Surf package 
select item_name, item_Frontid
from Inventory b, Packages c, Item a
where a.inv_id = b.inv_id and b.inv_id = c.inv_id and pack_name = 'Surf' and inv_name = 'Surfboard';
